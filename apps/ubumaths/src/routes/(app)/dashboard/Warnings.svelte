<script lang="ts">
	...
	const term2Start = DateTime.fromISO('2024-11-29')
...
<div class="card mt-8">
	<header class="card-header">
		...
		<div class="flex w-full justify-end">
			<button
				class={'btn m-2 ' + (lang === 'fr' ? 'variant-filled-primary' : 'variant-filled-tertiary')}
				on:click={() => (lang = 'fr')}>Français</button
			>
			<button
				class={'btn m-2 ' + (lang === 'en' ? 'variant-filled-primary' : 'variant-filled-tertiary')}
				on:click={() => (lang = 'en')}>English</button
			>
			<button
				class={'btn m-2 ' + (lang === 'ar' ? 'variant-filled-primary' : 'variant-filled-tertiary')}
