...
<div class="mt-6">
	<div class="mb-4 text-2xl font-bold">{category}</div>
			...
			{#if count > 0}
				<div class="flex flex-col items-center">
					<div class="relative">
						{#if count > 1}
							<span
								class="badge-icon variant-filled-success absolute -right-0 -top-0 z-10 h-10 w-10"
								><span class="text-xl text-white">{count}</span></span
							>
