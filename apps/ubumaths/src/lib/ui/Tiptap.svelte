<script lang="ts">
	...
	import IconBulletList from '$lib/ui/icons/IconBulletList.svelte'
	import IconNumberList from '$lib/ui/icons/IconNumberList.svelte'
	import IconCode from '$lib/ui/icons/IconCode.svelte'
	import IconCodeBlock from '$lib/ui/icons/IconCodeBlock.svelte'
	import IconQuote from '$lib/ui/icons/IconQuote.svelte'
	import IconReturn from '$lib/ui/icons/IconReturn.svelte'
	import IconUndo from '$lib/ui/icons/IconUndo.svelte'
	import IconRedo from '$lib/ui/icons/IconRedo.svelte'
	...
	import IconYoutube from '$lib/ui/icons/IconYoutube.svelte'
...
<style lang="postcss">
	...
	.editor-button {
		@apply bg-tertiary-500 h-8 rounded px-2 py-1;
	}
</style>
